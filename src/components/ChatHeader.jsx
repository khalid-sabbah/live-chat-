  ...
  return (
    <>
      <div className="head-container  border-b border-gray-200 p-3 flex items-center justify-between ">
            ...
            <IoIosArrowDropleftCircle onClick={close} className='self-center text-customPurp w-6 h-6 hover:cursor-pointer lg:hidden'/>
              ...
              <div className="flex flex-col">
                <span className="font-bold">{currentChat}</span>
